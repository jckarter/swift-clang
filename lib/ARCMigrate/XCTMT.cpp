...
static TKPair TKMacros[] = {
  ...
  {"STAssertEquals",              "XCTAssertEquals"},
  {"STAssertEqualsWithAccuracy",  "XCTAssertEqualsWithAccuracy"},
  ...
  {"shouldnt",                    "STAssertFalse"},
  {"shouldnt1",                   "STAssertFalse"},
  {"shouldBeEqual",               "STAssertEquals"},
  {"shouldBeEqual1",              "STAssertEquals"},
  {"shouldRaise",                 "STAssertThrows"},
  {"shouldRaise1",                "STAssertThrows"},
  {"shouldntRaise",               "STAssertNoThrow"},
  {"shouldntRaise1",              "STAssertNoThrow"},
  {"fail",                        "STFail"},
  {"fail1",                       "STFail"},
  {"shouldnoraise",               "STAssertNoThrow"},
  {"should1noraise",              "STAssertNoThrow"},
  {"shouldntnoraise",             "STAssertThrows"},
  {"shouldnt1noraise",            "STAssertThrows"},
