// RUN: %clang_skip_driver -c %s -arch x86_64 %xcode_c_warnings -O0 -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch i386 %xcode_c_warnings -O0 -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch arm64 %xcode_c_warnings -O0 -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch armv7 %xcode_c_warnings -O0 -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch x86_64 %xcode_c_warnings -Os -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch i386 %xcode_c_warnings -Os -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch arm64 %xcode_c_warnings -Os -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch armv7 %xcode_c_warnings -Os -g -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch x86_64 %xcode_c_warnings -O2 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch i386 %xcode_c_warnings -O2 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch arm64 %xcode_c_warnings -O2 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch armv7 %xcode_c_warnings -O2 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch x86_64 %xcode_c_warnings -O3 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch i386 %xcode_c_warnings -O3 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch arm64 %xcode_c_warnings -O3 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
// RUN: %clang_skip_driver -c %s -arch armv7 %xcode_c_warnings -O3 -Wno-unneeded-internal-declaration -Wno-enum-conversion -Wno-conditional-uninitialized -Wno-shorten-64-to-32
