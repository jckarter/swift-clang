...
CLANG_REPOSITORY_STRING_NO_KLONDIKE := $(subst clang_KLONDIKE,clang,$(CLANG_REPOSITORY_STRING))
CPP.Flags += -DCLANG_REPOSITORY_STRING='"$(CLANG_REPOSITORY_STRING_NO_KLONDIKE)"'
endif
