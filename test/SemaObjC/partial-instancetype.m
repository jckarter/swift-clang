...
@partial_interface Subclass1 : Root;
@partial_interface Subclass2 : Root;
@partial_interface Subsubclass1 : Subclass1;
@partial_interface Subclass3;
@partial_interface Subclass4 : Root;
@partial_interface MyClass : Root;
@partial_interface A4 : Root;
@partial_interface B4 : Root;
