...
array[10] = 0; // expected-warning {{instance method '-objectAtIndexedSubscript:put:' not found (return type defaults to 'id')}}

id<P> p_array;
oldObject = p_array[10]; // expected-warning {{instance method '-objectAtIndexedSubscript:' not found (return type defaults to 'id')}}

p_array[10] = 0; // expected-warning {{instance method '-objectAtIndexedSubscript:put:' not found (return type defaults to 'id')}}
}
