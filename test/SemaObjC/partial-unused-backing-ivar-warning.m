...
@partial_interface Example : NSObject;
@partial_interface CalDAVServerVersion;
@partial_interface CalDAVConcreteServerVersion : CalDAVServerVersion;
@partial_interface CalendarServerVersion : CalDAVConcreteServerVersion;
@partial_interface CDBModifyRecordsOperation : NSObject;
@partial_interface GATTOperation : NSObject;
@partial_interface Radar15727327 : NSObject;
@partial_interface I1;
@partial_interface MyFirstClass : NSObject;
@partial_interface MySecondClass : NSObject;
@partial_interface UnrelatedClass : NSObject;
@partial_interface MUIWebAttachmentController : NSObject;
