...
typedef nullptr_t __nonnull nonnull_nullptr_t; // expected-warning{{nullability specifier '__nonnull' applied to always-null pointer type 'nullptr_t'}}
...
typedef AddNonNull<nullptr_t>::type nonnull_int_ptr_3; // don't warn here
