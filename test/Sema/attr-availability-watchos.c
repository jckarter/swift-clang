...
void f6(int) __attribute__((availability(ios,deprecated=12.1))); // OK - deprecated Watch OS 3.1
...
void test() {
  f0(0); // expected-warning{{'f0' is deprecated: first deprecated in AppleWatchOS 2.0}}
  f1(0);
  f2(0); // expected-warning{{'f2' is deprecated: first deprecated in AppleWatchOS 2.0}}
  f3(0);
  f4(0); // expected-error {{f4' is unavailable: obsoleted in AppleWatchOS 2.0}}
  f5(0); // expected-warning {{'f5' is deprecated: first deprecated in AppleWatchOS 2.0}}
  f6(0);
  f7(0); // expected-warning {{'f7' is deprecated: first deprecated in AppleWatchOS 2.0}}
  f8(0); // expected-error {{'f8' is unavailable: obsoleted in AppleWatchOS 3.0}}
}

// Test AppleWatchOS specific attributes.
...
void test_watchos() {
  f0_watchos(0); // expected-warning{{'f0_watchos' is deprecated: first deprecated in AppleWatchOS 2.1}}
  f1_watchos(0);
  f2_watchos(0); // expected-warning{{'f2_watchos' is deprecated: first deprecated in AppleWatchOS 3.0}}
  f3_watchos(0);
  f4_watchos(0); // expected-error{{'f4_watchos' is unavailable: obsoleted in AppleWatchOS 3.0}}
  ...
  f5b_watchos(0); // expected-warning {{'f5b_watchos' is deprecated: first deprecated in AppleWatchOS 3.0}}
  // We get a deprecated warning here because both attributes are 'ios' (both get mapped to 'watchos').
  f5c_watchos(0); // expected-warning {{'f5c_watchos' is deprecated: first deprecated in AppleWatchOS 2.0}}
  f6_watchos(0); // expected-warning {{'f6_watchos' is deprecated: first deprecated in AppleWatchOS 3.0}}
}
