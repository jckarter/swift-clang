...
// RUN: c-index-test service -code-completion-at=%s:17:3 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:17:7 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:24:7 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:33:3 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:33:8 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:37:7 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:42:3 %s | FileCheck -check-prefix=CHECK-CC7 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:52:21 %s | FileCheck -check-prefix=CHECK-CC8 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:52:19 %s | FileCheck -check-prefix=CHECK-CC9 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:52:36 %s | FileCheck -check-prefix=CHECK-CCA %s
// CHECK-CCA: NotImplemented:{TypedText y2} (40)
// RUN: c-index-test -code-completion-at=%s:56:3 %s | FileCheck -check-prefix=CHECK-CCB %s
// RUN: c-index-test service -code-completion-at=%s:56:3 %s | FileCheck -check-prefix=CHECK-CCB %s
...
// RUN: c-index-test service -code-completion-at=%s:56:8 %s | FileCheck -check-prefix=CHECK-CCC %s
...
// RUN: c-index-test service -code-completion-at=%s:56:21 %s | FileCheck -check-prefix=CHECK-CCD %s
...
// RUN: c-index-test service -code-completion-at=%s:56:38 %s | FileCheck -check-prefix=CHECK-CCE %s
...
// RUN: c-index-test service -code-completion-at=%s:60:4 %s | FileCheck -check-prefix=CHECK-CCF %s
...
// RUN: c-index-test service -code-completion-at=%s:60:11 %s | FileCheck -check-prefix=CHECK-CCG %s
...
// RUN: c-index-test service -code-completion-at=%s:60:24 %s | FileCheck -check-prefix=CHECK-CCF %s
// RUN: c-index-test -code-completion-at=%s:60:26 %s | FileCheck -check-prefix=CHECK-CCH %s
// RUN: c-index-test service -code-completion-at=%s:60:26 %s | FileCheck -check-prefix=CHECK-CCH %s
...
// RUN: c-index-test service -code-completion-at=%s:5:4 %s | FileCheck -check-prefix=CHECK-IBACTION %s
...
// RUN: c-index-test service -code-completion-at=%s:68:9 %s | FileCheck -check-prefix=CHECK-8939352 %s
...
// RUN: c-index-test service -code-completion-at=%s:72:2 %s | FileCheck -check-prefix=CHECK-ONEWAY %s
...
// RUN: c-index-test service -code-completion-at=%s:85:2 %s | FileCheck -check-prefix=CHECK-CLASSTY %s
...
// RUN: c-index-test service -code-completion-at=%s:96:2 %s -target x86_64-apple-macosx10.7 | FileCheck -check-prefix=CHECK-NULLABILITY %s
...
// RUN: c-index-test service -code-completion-at=%s:107:2 %s -target x86_64-apple-macosx10.7 | FileCheck -check-prefix=CHECK-NULLABILITY2 %s
