...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test -code-completion-at=%s:9:20 %s 2>%t.1 | FileCheck -check-prefix=CHECK-CC1 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:9:20 %s 2>%t.2 | FileCheck -check-prefix=CHECK-CC1 %s
// RUN: not grep error %t.1
// RUN: not grep error %t.2
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:9:20 %s -fms-compatibility | FileCheck -check-prefix=CHECK-CC1 %s

// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test -code-completion-at=%s:10:24 %s | FileCheck -check-prefix=CHECK-CC2 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:10:24 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:12:11 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:13:22 %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test -code-completion-at=%s:14:16 %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:14:16 %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test -code-completion-at=%s:15:14 %s | FileCheck -check-prefix=CHECK-CC3 %s
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:15:14 %s | FileCheck -check-prefix=CHECK-CC3 %s
