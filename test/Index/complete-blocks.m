...
// RUN: c-index-test service -code-completion-at=%s:8:1 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:17:6 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:25:6 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test service -code-completion-at=%s:34:6 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: c-index-test service -code-completion-at=%s:25:15 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: c-index-test service -code-completion-at=%s:42:6 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: c-index-test service -code-completion-at=%s:50:1 %s | FileCheck -check-prefix=CHECK-CC7 %s
...
// RUN: c-index-test service -code-completion-at=%s:50:6 %s | FileCheck -check-prefix=CHECK-CC8 %s
