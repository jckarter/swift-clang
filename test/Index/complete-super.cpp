...
// RUN: c-index-test service -code-completion-at=%s:16:3 %s | FileCheck -check-prefix=CHECK-FOO-UNQUAL %s
...
// RUN: c-index-test service -code-completion-at=%s:20:3 %s | FileCheck -check-prefix=CHECK-BAR-UNQUAL %s
...
// RUN: c-index-test service -code-completion-at=%s:16:6 %s | FileCheck -check-prefix=CHECK-FOO-QUAL %s
...
// RUN: c-index-test service -code-completion-at=%s:5:1 %s | FileCheck -check-prefix=CHECK-ACCESS %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:5:1 %s | FileCheck -check-prefix=CHECK-ACCESS-PATTERN %s
