...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:17:1 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:56:12 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:58:6 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:59:12 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:102:20 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:104:8 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:105:20 %s | FileCheck -check-prefix=CHECK-CC7 %s
