...
// RUN: c-index-test service -code-completion-at=%s:4:9 -std=c++98 %s | FileCheck %s
// RUN: c-index-test -code-completion-at=%s:13:7 -std=c++98 %s | FileCheck %s
// RUN: c-index-test service -code-completion-at=%s:13:7 -std=c++98 %s | FileCheck %s
...
// RUN: c-index-test service -code-completion-at=%s:18:41 %s | FileCheck -check-prefix=CHECK-CTOR-INIT %s
...
// RUN: c-index-test service -code-completion-at=%s:18:55 %s | FileCheck -check-prefix=CHECK-CTOR-INIT-2 %s
