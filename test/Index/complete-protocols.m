...
// RUN: c-index-test service -code-completion-at=%s:9:11 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:9:21 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:12:11 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:9:11 %s | FileCheck -check-prefix=CHECK-CC1 %s
