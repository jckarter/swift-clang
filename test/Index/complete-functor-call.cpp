...
// RUN: c-index-test service -code-completion-at=%s:16:5 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:17:5 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:18:5 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test service -code-completion-at=%s:18:7 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: c-index-test service -code-completion-at=%s:18:10 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: c-index-test service -code-completion-at=%s:19:17 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: c-index-test service -code-completion-at=%s:19:28 %s | FileCheck -check-prefix=CHECK-CC7 %s
...
// RUN: c-index-test service -code-completion-at=%s:19:31 %s | FileCheck -check-prefix=CHECK-CC8 %s
...
// RUN: c-index-test service -code-completion-at=%s:19:35 %s | FileCheck -check-prefix=CHECK-CC9 %s
...
// RUN: c-index-test service -code-completion-at=%s:21:8 %s | FileCheck -check-prefix=CHECK-CC10 %s
...
// RUN: c-index-test service -code-completion-at=%s:22:7 %s | FileCheck -check-prefix=CHECK-CC11 %s
...
// RUN: c-index-test service -code-completion-at=%s:23:15 %s | FileCheck -check-prefix=CHECK-CC12 %s
...
// RUN: c-index-test service -code-completion-at=%s:12:28 %s | FileCheck -check-prefix=CHECK-CC13 %s
