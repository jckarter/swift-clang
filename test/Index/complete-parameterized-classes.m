...
// RUN: c-index-test service -code-completion-at=%s:25:8 %s | FileCheck -check-prefix=CHECK-CC0 %s
...
// RUN: c-index-test service -code-completion-at=%s:26:7 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:27:8 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:31:8 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test service -code-completion-at=%s:32:7 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: c-index-test service -code-completion-at=%s:33:8 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: c-index-test service -code-completion-at=%s:37:2 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: c-index-test service -code-completion-at=%s:41:8 %s | FileCheck -check-prefix=CHECK-CC7 %s
// CHECK-CC7: ObjCInterfaceDecl:{TypedText MyClsA}
// RUN: c-index-test -code-completion-at=%s:42:12 %s > %t.out
// RUN: c-index-test service -code-completion-at=%s:42:12 %s > %t.out
