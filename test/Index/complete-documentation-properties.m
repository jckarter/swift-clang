...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:47:16 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:48:13 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:49:13 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:50:13 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:51:9 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:52:12 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
@end
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test -code-completion-at=%s:93:6 %s | FileCheck -check-prefix=CHECK-CC7 %s
// RUN: env CINDEXTEST_COMPLETION_BRIEF_COMMENTS=1 c-index-test service -code-completion-at=%s:93:6 %s | FileCheck -check-prefix=CHECK-CC7 %s
