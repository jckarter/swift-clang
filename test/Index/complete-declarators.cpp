...
// RUN: c-index-test service -code-completion-at=%s:8:5 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:8:5 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:8:11 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:8:11 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:13:7 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:13:7 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test service -code-completion-at=%s:14:14 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:14:14 %s | FileCheck -check-prefix=CHECK-CC4 %s
