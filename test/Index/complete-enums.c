...
// RUN: c-index-test service -code-completion-at=%s:11:1 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:12:8 %s | FileCheck -check-prefix=CHECK-CC2 %s
