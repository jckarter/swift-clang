...
// RUN: c-index-test service -code-completion-at=%s:13:2 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: c-index-test service -code-completion-at=%s:14:7 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:14:7 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: c-index-test service -code-completion-at=%s:15:1 -fobjc-arc -fobjc-nonfragile-abi  %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_EDITING=1 CINDEXTEST_COMPLETION_CACHING=1 c-index-test service -code-completion-at=%s:15:1 -fobjc-arc -fobjc-nonfragile-abi %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: c-index-test service -code-completion-at=%s:15:5 %s | FileCheck -check-prefix=CHECK-CC4 %s
// RUN: c-index-test -code-completion-at=%s:16:5 %s | FileCheck -check-prefix=CHECK-CC4 %s
// RUN: c-index-test service -code-completion-at=%s:16:5 %s | FileCheck -check-prefix=CHECK-CC4 %s
// RUN: c-index-test -code-completion-at=%s:16:14 %s | FileCheck -check-prefix=CHECK-CC4 %s
// RUN: c-index-test service -code-completion-at=%s:16:14 %s | FileCheck -check-prefix=CHECK-CC4 %s
