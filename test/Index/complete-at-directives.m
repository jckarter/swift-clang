...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:2:2 %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:3:2 %s | FileCheck -check-prefix=CHECK-CC2 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:6:2 %s | FileCheck -check-prefix=CHECK-CC3 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:2:1 %s | FileCheck -check-prefix=CHECK-CC4 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:3:1 %s | FileCheck -check-prefix=CHECK-CC5 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:2:23 %s | FileCheck -check-prefix=CHECK-CC6 %s
...
// RUN: env CINDEXTEST_CODE_COMPLETE_PATTERNS=1 c-index-test service -code-completion-at=%s:2:22 %s | FileCheck -check-prefix=CHECK-CC7 %s
