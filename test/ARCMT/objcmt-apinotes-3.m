...
// RUN: rm -rf %t
// RUN: %clang_cc1 -fblocks -mt-migrate-directory %t -objcmt-migrate-apinotes -fapinotes -fapinotes-cache-path=%t/APINotesCache -I %S/../APINotes/Inputs/Headers -F %S/../APINotes/Inputs/Frameworks %s
