...
// Check internal sdk as well
// RUN: rm -rf %t/SDKs/iPhoneOS8.0.Internal.sdk
// RUN: mkdir -p %t/SDKs/iPhoneOS8.0.Internal.sdk
// RUN: env SDKROOT=%t/SDKs/iPhoneOS8.0.Internal.sdk %clang -target arm64-apple-darwin %s -### 2>&1 \
// RUN:   | FileCheck --check-prefix=CHECK-IPHONE %s
//
// CHECK-IPHONE: clang
// CHECK-IPHONE: "-cc1"
